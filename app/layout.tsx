// app/layout.tsx
// Removed any "use client" from layout (server component).
// metadata export is valid.
// CartDisplay works as a child client component.
// Links updated (Products → /products).
